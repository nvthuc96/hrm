...
/**
 * Minimal, reusable .xlsx writer. Given a sheet name, headers and rows of plain values, it produces
 * the workbook bytes with a bold header row and sensible per-type cell formatting.
 */
