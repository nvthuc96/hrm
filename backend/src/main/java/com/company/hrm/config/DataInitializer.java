...
/**
 * Seeds a default admin user on first startup (roles are seeded by Flyway V1). Default credentials:
  ...
  public void run(String... args) {
    ...
    Role adminRole =
        roleRepository
            ...
            .orElseThrow(
                () -> new IllegalStateException("ROLE_ADMIN missing; run Flyway migrations"));
