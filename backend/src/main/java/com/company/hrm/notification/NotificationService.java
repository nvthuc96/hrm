...
public class NotificationService {
  ...
  public void notifyEmployee(
      Long employeeId, NotificationType type, String title, String message, String link) {
    if (employeeId == null) {
      return;
    }
  ...
  public void notifyRoles(
      Set<String> roleNames, NotificationType type, String title, String message, String link) {
