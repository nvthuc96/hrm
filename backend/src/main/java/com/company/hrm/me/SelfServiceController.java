...
/**
 * Employee self-service. Every endpoint operates on the authenticated user's own employee record;
 * the employee id is resolved from the JWT, never trusted from the request body or query string.
 */
@RestController
...
public class SelfServiceController {
  ...
  public MeResponse me() {
    ...
    EmployeeResponse employee =
        user.getEmployeeId() != null ? employeeService.getById(user.getEmployeeId()) : null;
